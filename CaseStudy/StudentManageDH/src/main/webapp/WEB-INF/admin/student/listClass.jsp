                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Student List By Class</h4>
                            <div>
                                        ...
                                        <div class="form-group mb-3">
                                            <select id="validationCustom08" name="classes" class="nice-select">
                                                ...
                                                <c:forEach var="classes" items="${applicationScope.listClass}">
                                                    <c:choose>
                                                        <c:when test="${classes.getC_id() == requestScope.classes}">
                                                            <option value="${classes.getC_id()}" selected>
                            ...
                            <div class="card-body">
                                <div class="table-responsive mt-3">
                                    <table class="table table-hover table-centered mb-0">
                                        ...
                                        <tbody>
                                        <c:forEach var="student" items="${requestScope.listClassStudent}">
                                            <tr>
                                        ...
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <c:if test="${requestScope.currentPage != 1}">
                                                <li class="page-item"><a class="page-link"
                                                                         href="/students?action=classes&page=${requestScope.currentPage - 1}&classes=${requestScope.classes}">Previous</a>
                                                </li>
                                            </c:if>
                                            <c:forEach begin="1" end="${noOfPages}" var="i">
                                                <c:choose>
                                                    <c:when test="${requestScope.currentPage eq i}">
                                                        <li class="page-item"><a class="page-link"
                                                                                 href="/students?action=classes&page=${i}&classes=${requestScope.classes}">${i}</a>
                                                        </li>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <li class="page-item"><a class="page-link"
                                            ...
                                            <c:if test="${requestScope.currentPage lt requestScope.noOfPages}">
                                                <li class="page-item"><a class="page-link"
                                                                         href="/students?action=classes&page=${requestScope.currentPage + 1}&classes=${requestScope.classes}">Next</a>
                                                </li>
                                            </c:if>
                                        </ul>
                                    </nav>
